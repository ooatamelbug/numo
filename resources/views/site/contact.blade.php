...
@section('content')
    ...
    <div class="breadcrumbs" data-aos="fade-in">
      <div class="container">
        ...
        <p>
نعمل باستمرار لجعل تجربتك من خلال استخدام موقعنا الإلكتروني أسهل, سنقوم بالرد على رسالتك في أقرب وقت ممكن
        </p>
      </div>
    </div>
...
" data-rule="email" data-msg="Please enter a valid email" />
              ...
              <div class="form-group">
                <input type="text" class="form-control" name="subject" id="subject" placeholder="الفئة *" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" />
                <div class="validate"></div>
              </div>
              <div class="form-group">
