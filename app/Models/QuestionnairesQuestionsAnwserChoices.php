...
class QuestionnairesQuestionsAnwserChoices extends Model
{
    use HasFactory;
    protected $fillable = [
      'anwser_number',
    ...
    public function questionnaires_questions_choices()
    {
        return $this->belongsTo(QuestionnairesQuestionsChoices::class, 'qnaires_q_ch_id');
    }
